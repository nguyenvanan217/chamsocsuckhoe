        ...
        <div>
            ...
            <div className="my-7 w-[1050px] mx-auto bg-[#38BDF8] p-6 rounded-lg">
                <div className="flex justify-around items-center mb-4 py-3 ">
                    ...
                    <input type="text" className={`${!isChangeInfo ? "bg-white" : "bg-[#eeeeee]"} flex basis-4/5 h-[40px] outline-none text-xl px-1`} onChange={e => setName(e.target.value)} value={name} disabled={isChangeInfo ? false : true} />
                </div>
                <div className="flex justify-around items-center mb-7">
                    <p className='text-lg basis-1/5'>Giới tính</p>
                    <input type="text" className={`${!isChangeInfo ? "bg-white" : "bg-[#eeeeee]"} flex basis-4/5 h-[40px] outline-none text-xl px-1`} onChange={e => setGender(e.target.value)} value={gender} disabled={isChangeInfo ? false : true} />
                </div>
                <div className="flex justify-around items-center mb-7">
                    <p className='text-lg basis-1/5'>Ngày Sinh</p>
                    <input type="date" className={`${!isChangeInfo ? "bg-white" : "bg-[#eeeeee]"} flex basis-4/5 h-[40px] outline-none text-xl px-1`} onChange={e => setBirthDate(e.target.value)} value={birthDate} disabled={isChangeInfo ? false : true} />
                </div>
                <div className="flex justify-around items-center mb-7">
                    <p className='text-lg basis-1/5'>Căn Cước CD (Nếu có)</p>
                    <input type="text" className={`${!isChangeInfo ? "bg-white" : "bg-[#eeeeee]"} flex basis-4/5 h-[40px] outline-none text-xl px-1`} onChange={e => setCccd(e.target.value)} value={cccd} disabled={isChangeInfo ? false : true} />
                </div>
                <div className="flex justify-around items-center mb-7">
                    <p className='text-lg basis-1/5'>Nơi sinh</p>
                    <input type="text" className={`${!isChangeInfo ? "bg-white" : "bg-[#eeeeee]"} flex basis-4/5 h-[40px] outline-none text-xl px-1`} onChange={e => setBirthPlace(e.target.value)} value={birthPlace} disabled={isChangeInfo ? false : true} />
                </div>
                <div className="flex justify-around items-center mb-7">
                    <p className='text-lg basis-1/5'>Địa chỉ thường trú</p>
                    <input type="text" className={`${!isChangeInfo ? "bg-white" : "bg-[#eeeeee]"} flex basis-4/5 h-[40px] outline-none text-xl px-1`} onChange={e => setAddress(e.target.value)} value={address} disabled={isChangeInfo ? false : true} />
                </div>
